...
const TermsOfService = () => {
  return (
    <>
      <title>Terms of Service | <BrandLogo showERP /></title>
      <meta
        name="description"
        content="Read the Terms of Service for <BrandLogo showERP /> — the rules, obligations, and rights that govern your use of the platform."
      />

      <LegalLayout
        title="Terms of Service"
        subtitle="These terms govern your use of <BrandLogo showERP />. By using the platform, your institution agrees to these terms. Please read them carefully."
      ...
      >
        <section id="acceptance" className="legal-section">
          ...
          <p>
            By accessing or using <BrandLogo showERP /> (the "Platform"), the school
          ...
          <p>
            ...
            institution and <BrandLogo showERP /> ("we," "us," or "our"). Use of the
        ...
        <section id="description" className="legal-section">
          ...
          <p>
            <BrandLogo showERP /> is a cloud-based school management platform designed
        ...
        <section id="eligibility" className="legal-section">
          ...
          <p>
            ...
            institutions and their authorised staff. By using <BrandLogo showERP />,
            you represent that:
          </p>
          <ul>
            <li>
        ...
        <section id="school-obligations" className="legal-section">
          ...
          <p>By using <BrandLogo showERP />, your institution agrees to:</p>
          <ul>
            <li>
        ...
        <section id="acceptable-use" className="legal-section">
          ...
          <p>You agree not to use <BrandLogo showERP /> to:</p>
          <ul>
            <li>
        ...
        <section id="data-ownership" className="legal-section">
          ...
          <p>
            All data entered into <BrandLogo showERP /> by a school — including student
        ...
        <section id="intellectual-property" className="legal-section">
          ...
          <p>
            <BrandLogo showERP />, including its design, codebase, features, and brand,
        ...
        <section id="payment" className="legal-section">
          ...
          <p>
            Access to <BrandLogo showERP /> is subject to the subscription or pricing
        ...
        <section id="availability" className="legal-section">
          ...
          <p>
            We strive to keep <BrandLogo showERP /> available and reliable. However,
        ...
        <section id="termination" className="legal-section">
          ...
          <p>
            Either party may terminate the use of <BrandLogo showERP /> by providing
        ...
        <section id="liability" className="legal-section">
          ...
          <p>
            To the fullest extent permitted by applicable law, <BrandLogo showERP />
        ...
        <section id="changes" className="legal-section">
          ...
          <p>
            Continued use of <BrandLogo showERP /> after an update to these Terms
        ...
        <section id="contact" className="legal-section">
          ...
          <p>
            ...
            institution's specific arrangement with <BrandLogo showERP />, please
            reach out through the platform or contact your account
            representative directly.
          </p>
          <p>
            <strong><BrandLogo showERP /></strong> — built to help schools run better,
